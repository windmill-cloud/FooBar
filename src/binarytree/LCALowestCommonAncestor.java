...
import structures.ParentTreeNode;
...
public class LCALowestCommonAncestor {
    ...
    public class SolutionWOParentPointer {
    ...
    public class SolutionWithParent{
        public ParentTreeNode getIntersectionNode(ParentTreeNode nodeA, ParentTreeNode nodeB) {
            ParentTreeNode iterA = nodeA, iterB = nodeB;

            int lenA = getLength(nodeA), lenB = getLength(nodeB);
            while(lenA > lenB) {
                iterA = iterA.parent;
                lenA--;
            }
        ...
        private int getLength(ParentTreeNode head){
            ParentTreeNode iter = head;
            int len = 0;
            while(iter!= null){
                iter = iter.parent;
                len++;
